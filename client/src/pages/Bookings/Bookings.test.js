...
import * as EventMocks from '../Events/mocks';
import { noEventsExistText } from '../../components/Booking/BookingModalContent';
import { getEventNameForBooking } from '../../components/Form/FormOptions';
import { 
    MOCK, 
    BOOK_AN_EVENT,
    SUBMIT,
